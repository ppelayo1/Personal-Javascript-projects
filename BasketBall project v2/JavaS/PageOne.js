    ...
    var timer = setInterval(function movL() {
        ...
        if (toss === false) {
            ...
            var ball = function () {
                //varibles
                var physics = {
                    gravity: 0.1, //speed of gravity
                    v: 7, //Velocity of ball, initially the initial velocity                    
                ...
                //Use wrapper setinterval to simulate a animation
                timer = setInterval(function () {
                    //clear the display then draw
                    cDisp();
